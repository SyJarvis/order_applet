...
python manage.py runjob -m stat/daily -a food -p 2020-02-01
...
class JobTask():
    ...
    def statSite(self, params):
        ...
        stat_new_member_count = Member.query.filter(Member.created_time >= date_from, PayOrder.created_time <=date_to).count()
